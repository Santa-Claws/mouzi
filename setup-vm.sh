...
echo ""
echo "AppImage:  $HOME/mouzi/src-tauri/target/release/bundle/appimage/Mouzi_0.1.2_amd64.AppImage"
echo ".deb:      $HOME/mouzi/src-tauri/target/release/bundle/deb/Mouzi_0.1.2_amd64.deb"
echo ".rpm:      $HOME/mouzi/src-tauri/target/release/bundle/rpm/Mouzi-0.1.2-1.x86_64.rpm"
echo ""
